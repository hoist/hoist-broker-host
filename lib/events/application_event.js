            ...
            return BBPromise.all(_.map(moduleDescriptions, _.bind(function (moduleDescription) {
              return this.getContext(application)
                ...
                .then(function (context) {
                  ...
                  var jobQueue = 'RunModule';
                  //simon load testing
                  console.log('application id:', this.applicationId, this.moduleDescription);
                  if (this.applicationId === '3WpOr0IoiXm8Ham4zFDP') {
                    console.log('modifying job');
                    jobQueue = jobQueue + '_simon';
                  }
                  var job = kueProxy.get().create(jobQueue, jobData);
